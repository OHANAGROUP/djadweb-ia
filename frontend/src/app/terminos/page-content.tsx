    ...
    <div style={{ minHeight: '100vh', background: 'var(--brand-bg)' }}>
      <div className="container" style={{ paddingTop: 120, paddingBottom: 60, maxWidth: 720 }}>
        ...
        <div style={{ background: 'var(--brand-card)', borderRadius: 16, padding: '40px 48px', border: '1px solid var(--gray-100)' }}>
          ...
          <p style={{ color: 'var(--gray-400)', lineHeight: 1.8, marginBottom: 16 }}>Al usar DEJAWEBIAR®, aceptas estos Términos de Servicio. Si no estás de acuerdo, no utilices el servicio.</p>
          <h2 style={{ fontSize: 18, fontWeight: 600, color: '#fff', marginTop: 32, marginBottom: 12 }}>2. Descripción del servicio</h2>
          <p style={{ color: 'var(--gray-400)', lineHeight: 1.8, marginBottom: 16 }}>DEJAWEBIAR® es un asistente que facilita consultas en portales del Estado chileno (PJUD, SII, TGR, Registro Civil, CMF, Extranjería). Actuamos como intermediario técnico; la información proviene de fuentes oficiales y no garantizamos su exactitud absoluta.</p>
          ...
          <p style={{ color: 'var(--gray-400)', lineHeight: 1.8, marginBottom: 16 }}>DEJAWEBIAR® no se hace responsable por: errores en portales oficiales, demoras en la actualización de datos, decisiones tomadas en base a la información consultada, o interrupciones del servicio por mantenimiento o causas externas.</p>
          <h2 style={{ fontSize: 18, fontWeight: 600, color: '#fff', marginTop: 32, marginBottom: 12 }}>5. Planes y facturación</h2>
          <p style={{ color: 'var(--gray-400)', lineHeight: 1.8, marginBottom: 16 }}>Ofrecemos planes Gratuito, Básico ($3.990/mes) y Premium ($7.990/mes). Las suscripciones se renuevan automáticamente. Puedes cancelar en cualquier momento desde tu panel de control.</p>
        </div>
      </div>
    </div>
  )
