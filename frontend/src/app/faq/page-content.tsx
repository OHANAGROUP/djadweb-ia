...
const faqs = [
  {
    q: "¿Qué es DEJAWEBEAR?",
    a: "DEJAWEBEAR es un asistente de inteligencia artificial que unifica consultas a portales del Estado chileno (PJUD, SII, TGR, CMF, etc.) en un solo lugar. Ya no necesitas tener mil claves ni perder horas navegando entre sitios: pregúntanos lo que necesitas saber y nosotros lo buscamos por ti."
  },
  {
    q: "¿Necesito ClaveÚnica para usar DEJAWEBEAR?",
  ...
  },
  {
    ...
    a: "Sí. El plan Gratuito te permite realizar consultas ilimitadas con resultados básicos. Si necesitas alertas por WhatsApp, historial completo o reportes avanzados, puedes suscribirte al plan Básico ($3.990/mes) o Premium ($7.990/mes)."
  },
  {
    q: "¿Cómo me llegan las alertas?",
    a: "Las alertas se envían por WhatsApp o email, según tu preferencia. Puedes configurar notificaciones para cambios en causas judiciales, vencimientos de deudas, actualizaciones SII, y más."
  },
  {
  ...
  {
    q: "¿Ofrecen soporte?",
    a: "Sí. Puedes contactarnos por email a hola@tramitai.cl o a través de nuestro WhatsApp. Respondemos en un plazo máximo de 24 horas hábiles."
  }
]
